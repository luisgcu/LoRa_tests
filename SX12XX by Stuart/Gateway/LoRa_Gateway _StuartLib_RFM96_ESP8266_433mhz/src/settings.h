...
#define NSS 2                                   //select pin on LoRa device
#define NRESET -1                               //reset pin on LoRa device
#define DIO0 15
#define DIO1 15                                 //DIO1 pin on LoRa device, used for RX and TX done 
#define DIO2 -1                                 //DIO2 pin on LoRa device, normally not used so set to -1 
#define PIXEL 0                                 //pixel led
...
const uint32_t Frequency      = 433000000;           //frequency of transmissions
...
#define GATEWAY_NAME "esp8266_433mhz"   //Placa verde Con sensor de temperatura
