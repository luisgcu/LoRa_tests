...
const uint32_t Frequency      = 433600000;           //frequency of transmissions
...
//#define GATEWAY_NAME "esp32_rfm96_433mhz"   //Placa verde con rtc
#define GATEWAY_NAME "esp32_rfm96_433mhz"   //Placa verde Con sensor de temperatura 433mhz
