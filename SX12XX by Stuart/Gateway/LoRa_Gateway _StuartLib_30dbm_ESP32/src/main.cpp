...
void packet_is_OK()
{
  ...
  if (client.publish("/v1.0/lora/espgtwy/nodes", output.c_str()))
...
void reconnect()
{
  while (!client.connected())
  {
    ...
    if (client.connect("lorasx1262-22dbm", mqttUser, mqttPassword))
    {
      Serial.println("connected");
      client.publish("/v1.0/lora/espgtwy/host_data", "{\"name\":\"lorasx1262-22dbm\"}");
    }
    else
    {
