...
#define RX_EN 22                                //pin for RX enable, used on some SX126X devices, set to -1 if not used
#define TX_EN 21                                //pin for TX enable, used on some SX126X devices, set to -1 if not used
...
const uint8_t Bandwidth     = LORA_BW_041;         //LoRa bandwidth LORA_BW_041, LORA_BW_062
