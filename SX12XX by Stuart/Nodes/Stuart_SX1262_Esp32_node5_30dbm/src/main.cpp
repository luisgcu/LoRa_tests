...
void setup()
{
  ...
  Serial1.begin(gpsbaud); //ESP32 
  //Serial1.begin(gpsbaud, SERIAL_8N1, RXD1, TXD1);  //ESP wrover 
  Serial.println(F("GPS SENDER-915-ID #5 Stuart-->updated August 2020"));
  Serial.println(F("Frecuency Adjust ID#2=915.009, Frecuency Gateway =915.0009"));
  pinMode(LED1, OUTPUT);
  pinMode(LED2, OUTPUT);
